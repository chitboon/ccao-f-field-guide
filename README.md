...
[![GitHub Pages](https://img.shields.io/badge/Guide-HTML-blue)](https://chitboon.github.io/ccao-f-field-guide/guide/)
[![GitHub last commit](https://img.shields.io/github/last-commit/chitboon/ccao-f-field-guide)](https://github.com/chitboon/ccao-f-field-guide/commits/main)
[![GitHub stars](https://img.shields.io/github/stars/chitboon/ccao-f-field-guide?style=social)](https://github.com/chitboon/ccao-f-field-guide/stargazers)
...
| **Domain reference** | Capability selection, configuration scope, governance triggers, failure taxonomy |

Also:

- **[LESSON-PLAN.md](LESSON-PLAN.md)** — a five-day strengthening sprint
- **[practice/](practice/)** — 106 items across three sets: 28 on frameworks, 18 five-activity sequencing items, and a 60-item sealed mock

## How to use this

See **[HOW-TO-PRACTISE.md](HOW-TO-PRACTISE.md)** for three things that matter more than reading front to back:

- **Run it in Cowork** — point Claude or Kimi at this cloned repo
- **The drill loop** — a paste-ready prompt that quizzes you one question at a time
- **Generate your own questions** once you've exhausted `practice/`

## Sources

Everything is traceable. See [SOURCES.md](SOURCES.md). Primary sources:

- The published **CCAO-F Exam Guide** (v1.0, July 2026)
- **AI Fluency: Framework & Foundations** — the 4Ds
- **Claude 101** — Projects, artifacts, skills
- **AI Capabilities and Limitations** — the four properties, training fingerprints

These courses are free at [academy.claude.com](https://academy.claude.com).
...
Compiled by **Chit Boon Lee** and **Claude**. Chit Boon Lee is CCAO-F certified. Unofficial. Not affiliated with, endorsed by, or sponsored by Anthropic.
